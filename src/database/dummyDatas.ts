...
// ('user13', '테스트', 'pwd1234', '테스트닉네임', 'user', '서울시 성동구', 0, DEFAULT, 0, DEFAULT)`;

// const userQuery = `INSERT INTO user (user_id, user_name, user_password, user_nickname, verify, user_location, user_img, delete_flag, deleted_at) VALUES
// ('admin1', '관리자1', 'pwd4321', '운영자1', 'admin', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('admin2', '관리자2', 'pwd4321', '운영자2', 'admin', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user1', '김민철', 'pwd1234', '민철', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user2', '이승연', 'pwd1234', '승연', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user3', '박민지', 'pwd1234', '민지', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user4', '최민수', 'pwd1234', '민수', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user5', '한영호', 'pwd1234', '영호', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user6', '장지원', 'pwd1234', '지원', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user7', '윤지은', 'pwd1234', '지은', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user8', '성유진', 'pwd1234', '유진', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user9', '양은지', 'pwd1234', '은지', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user10', '유준형', 'pwd1234', '준형', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user11', '임지훈', 'pwd1234', '지훈', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT),
// ('user12', '송기훈', 'pwd1234', '기훈', 'user', '서울시 성동구', DEFAULT, 0, DEFAULT);`;
...
(DEFAULT, '1953249219', 'user5', '의사선생님이 친절해요!', 5, DEFAULT, DEFAULT),
(DEFAULT, '1953249219', 'user5', '병원비가 저렴해요!', 5, DEFAULT, DEFAULT),
(DEFAULT, '1953249219', 'user5', '강아지가 좋아했어요!', 5, DEFAULT, DEFAULT),
